...
| 1.14.4, 1.15.2, 1.16.5 baselines covering 1.14.4–1.16.5 | Separate Fabric targets per version family | Planned, unsupported |
...
| `1.14.x` | `aa46e72f60a9b306d5ee6e3b5b1940d84e7b2fdd` | 1.14.4 | 28.2.26 | Java 8, Gradle 8.12, Unimined 1.4.2-SNAPSHOT, intermediary + Mojmap; Fabric Loader 0.16.14, Fabric API 0.28.5+1.14 |
| `1.15.x` | `6c421dcce2d3889b2965fa69ded9dbd46ec416da` | 1.15.2 | 31.2.57 | Java 8, Gradle 8.12, Unimined 1.4.2-SNAPSHOT, intermediary + Mojmap; Fabric Loader 0.16.14, Fabric API 0.28.5+1.15 |
| `1.16.x` | `6d32a539731c4cf22bb1923083f48dce5f9adb22` | 1.16.5 | 36.2.34 | Java 8, Gradle 8.12, Unimined 1.4.2-SNAPSHOT, intermediary + Mojmap; Fabric Loader 0.16.14, Fabric API 0.42.0+1.16 |
...
e4steam deliverable remains Forge for 1.6.4-1.16.5 plus separate ordinary
Fabric targets covering 1.14.4-1.16.5.
