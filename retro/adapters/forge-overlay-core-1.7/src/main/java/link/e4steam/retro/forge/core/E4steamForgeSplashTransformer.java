...
public final class E4steamForgeSplashTransformer implements IClassTransformer {
    private static final String SPLASH_CLASS = "cpw.mods.fml.client.SplashProgress";
    private static final String SPLASH_OWNER = "cpw/mods/fml/client/SplashProgress";
                    ...
                    return new MethodVisitor(Opcodes.ASM4, delegate) {
                        ...
                        public void visitFieldInsn(
                            ...
                            if (opcode == Opcodes.PUTSTATIC
                                ...
                                // Keep Forge's config/resource initialization, but replace
                                // only the computed splash-enabled value with false.
